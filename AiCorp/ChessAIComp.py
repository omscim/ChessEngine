...
function_map = {
    ...
    "drawMoveLog": drawMoveLog,
    "animateMove": animateMove,
    "drawEndGameText": drawEndGameText
...
DATA_ENGINEER_PROMPT = ("""You follow an approved plan. You write python/shell code to solve tasks. Wrap the code in a code block that specifies the script type.
